% config-dlitz-apt(SECTION) | User Commands
%
% "July  5 2023"
...
config-dlitz-apt - program to do something

# SYNOPSIS

**config-dlitz-apt** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**config-dlitz-apt** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **config-dlitz-apt** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**config-dlitz-apt** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    config-dlitz-apt. See **foo.conf**(5) for further details.
...
**config-dlitz-apt** provides some return codes, that can be used in scripts:
